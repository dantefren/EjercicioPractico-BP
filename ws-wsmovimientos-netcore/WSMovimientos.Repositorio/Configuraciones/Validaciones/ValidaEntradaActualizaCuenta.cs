...
namespace WSMovimientos.Repositorio.Configuraciones.Validaciones
{
    ...
    /// 
    /// </summary>
    public class ValidaEntradaActualizaCuenta : AbstractValidator<EEntrada<EEntradaActualizaCuenta>>
    {
        /// <summary>
        /// 
        /// </summary>
        public ValidaEntradaActualizaCuenta()
        {
            ...
            When(entrada => entrada.BodyIn.IsNotNull(), () =>
            {
                 ...
                 RuleFor(entrada => entrada.BodyIn.Cuenta).SetValidator(new ValidaCuentaActualiza());
