...
namespace WSMovimientos.Repositorio.Configuraciones.Validaciones
{
    ...
    /// 
    /// </summary>
    public class ValidaEntradaCreaCuenta : AbstractValidator<EEntrada<EEntradaCreaCuenta>>
    {
        /// <summary>
        /// 
        /// </summary>
        public ValidaEntradaCreaCuenta()
        {
            ...
            {
                RuleFor(entrada => entrada.BodyIn.Cuenta).SetValidator(new ValidaCuentaCrea());
            });
        }
    }
}