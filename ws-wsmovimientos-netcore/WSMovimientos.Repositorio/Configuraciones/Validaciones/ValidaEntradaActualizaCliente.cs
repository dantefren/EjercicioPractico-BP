...
namespace WSMovimientos.Repositorio.Configuraciones.Validaciones
{
    ...
    /// 
    /// </summary>
    public class ValidaEntradaActualizaCliente : AbstractValidator<EEntrada<EEntradaActualizaCliente>>
    {
        /// <summary>
        /// 
        /// </summary>
        public ValidaEntradaActualizaCliente()
        {
            ...
            When(entrada => entrada.BodyIn.IsNotNull(), () =>
            {
                 ...
                 RuleFor(entrada => entrada.BodyIn.Cliente).SetValidator(new ValidaClienteActualiza());
