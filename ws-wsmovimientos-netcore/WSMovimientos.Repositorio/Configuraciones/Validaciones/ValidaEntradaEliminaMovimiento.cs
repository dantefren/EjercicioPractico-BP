...
namespace WSMovimientos.Repositorio.Configuraciones.Validaciones
{
    ...
    /// 
    /// </summary>
    public class ValidaEntradaEliminaMovimiento : AbstractValidator<EEntrada<EEntradaEliminaMovimiento>>
    {
        /// <summary>
        /// 
        /// </summary>
        public ValidaEntradaEliminaMovimiento()
        {
            ...
            {
                RuleFor(entrada => entrada.BodyIn.Movimiento).SetValidator(new ValidaMovimientoElimina());
            });
