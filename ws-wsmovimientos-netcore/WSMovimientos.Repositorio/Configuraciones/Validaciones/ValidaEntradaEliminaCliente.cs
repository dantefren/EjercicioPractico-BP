...
namespace WSMovimientos.Repositorio.Configuraciones.Validaciones
{
    ...
    /// 
    /// </summary>
    public class ValidaEntradaEliminaCliente : AbstractValidator<EEntrada<EEntradaEliminaCliente>>
    {
        /// <summary>
        /// 
        /// </summary>
        public ValidaEntradaEliminaCliente()
        {
            ...
            {
                RuleFor(entrada => entrada.BodyIn.Cliente).SetValidator(new ValidaClienteElimina());
            });
