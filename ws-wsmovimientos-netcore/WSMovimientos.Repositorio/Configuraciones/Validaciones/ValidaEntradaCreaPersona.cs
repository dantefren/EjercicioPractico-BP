...
namespace WSMovimientos.Repositorio.Configuraciones.Validaciones
{
    ...
    /// 
    /// </summary>
    public class ValidaEntradaCreaPersona : AbstractValidator<EEntrada<EEntradaCreaPersona>>
    {
        /// <summary>
        /// 
        /// </summary>
        public ValidaEntradaCreaPersona()
        {
            ...
            {
                RuleFor(entrada => entrada.BodyIn.Persona).SetValidator(new ValidaPersonaCrea());
            });
        }
    }
}